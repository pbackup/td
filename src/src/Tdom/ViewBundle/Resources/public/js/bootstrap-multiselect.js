...
!function($) {
    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonClass: 'btn btn-selectbox',
            dropRight: true,
            selectedClass: 'active2',
            buttonWidth: 'auto',
            buttonContainer: '<div class="select-group" />',
            wrapContainer: '<div class="game-option-group multiselect-container dropdown-menu" />',
            ...
            templates: {
                ...
                ul: '<ul class="list-left"></ul>',
                ulSelectedList: '<ul class="list-right multiselect-item"></ul>',
                filter: '<ul><li class="multiselect-item filter"><div class="input-group"><input class="form-control multiselect-search" type="text"><span class="input-group-addon btn-default"><i class="fa fa-search"></i></span></div></li></ul>',
                li: '<li><a href="javascript:void(0);"><label></label></a></li>',
                divider: '<li class="multiselect-item divider"></li>',
                liGroup: '<li class="multiselect-item group"><label class="multiselect-group"></label></li>',
                footer: '<div class="dropdown-footer"><small>A game missing from the list? <a href="" id="quick_my_games_link"> Go to your profile to add it. </a></small></div>'
            }
        },
        ...
        buildDropdown: function() {
            ...
            this.$ulSelectedList = $(this.options.templates.ulSelectedList);
            this.$wrapContainer = $(this.options.wrapContainer);
            ...
            this.$wrapContainer.append(this.$ul);
            this.$wrapContainer.append(this.$ulSelectedList);
            this.$wrapContainer.append(this.options.templates.footer);
            this.$container.append(this.$wrapContainer);
        },
        ...
        buildFilter: function() {
            ...
            if (this.options.enableFiltering || this.options.enableCaseInsensitiveFiltering) {
                ...
                if (this.$select.find('option').length >= enableFilterLength) {
                    ...
                    this.$wrapContainer.prepend(this.$filter);
